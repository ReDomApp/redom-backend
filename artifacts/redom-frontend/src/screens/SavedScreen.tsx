...
const styles = StyleSheet.create({
  root:{flex:1,backgroundColor:"#FFF"}, header:{height:58,borderBottomWidth:1,borderBottomColor:"#E4E6EB",flexDirection:"row",alignItems:"center",justifyContent:"space-between",paddingHorizontal:16}, title:{fontSize:20,fontWeight:"800",color:"#050505"},searchInput:{flex:1,marginHorizontal:14,fontSize:17},tabs:{paddingHorizontal:12,paddingVertical:10,gap:8},tab:{paddingHorizontal:20,paddingVertical:10,borderRadius:22},tabActive:{backgroundColor:"#E5F1FF"},tabText:{fontSize:16,color:"#050505"},tabTextActive:{color:BLUE,fontWeight:"700"},content:{paddingHorizontal:22,paddingBottom:50},collectionsContent:{paddingHorizontal:22,paddingBottom:50},sectionHeader:{flexDirection:"row",alignItems:"center",justifyContent:"space-between",marginTop:34,marginBottom:20},sectionTitle:{fontSize:24,fontWeight:"800",color:"#050505"},link:{fontSize:17,color:"#1877F2"},newCollectionRow:{height:70,flexDirection:"row",alignItems:"center",gap:14},collectionIcon:{width:54,height:54,borderRadius:27,backgroundColor:"#EEF0F3",alignItems:"center",justifyContent:"center"},newCollectionText:{flex:1,fontSize:18,fontWeight:"700",color:"#050505"},chevron:{fontSize:40,color:"#65676B",lineHeight:42},recentTitle:{fontSize:22,fontWeight:"800",marginTop:28,marginBottom:10,color:"#050505"},empty:{alignItems:"center",paddingTop:90,paddingHorizontal:40},emptyTitle:{fontSize:27,fontWeight:"800",color:"#65676B",textAlign:"center",marginTop:8},emptyBody:{fontSize:18,lineHeight:25,color:"#65676B",textAlign:"center",marginTop:12},savedCard:{flexDirection:"row",borderTopWidth:1,borderTopColor:"#E4E6EB",paddingVertical:14},savedBadge:{width:42,height:42,borderRadius:21,backgroundColor:"#EEF0F3",alignItems:"center",justifyContent:"center"},savedCopy:{flex:1,marginLeft:12},savedType:{fontSize:13,fontWeight:"700",color:BLUE,textTransform:"capitalize"},savedText:{fontSize:16,color:"#050505",marginTop:3},savedDate:{fontSize:12,color:"#65676B",marginTop:5},collectionRow:{flexDirection:"row",alignItems:"center",paddingVertical:14,borderBottomWidth:1,borderBottomColor:"#E4E6EB"},collectionCopy:{flex:1,marginLeft:14},collectionName:{fontSize:17,fontWeight:"700",color:"#050505"},collectionMeta:{fontSize:13,color:"#65676B",marginTop:3},collectionEmpty:{paddingTop:120,alignItems:"center"},collectionEmptyText:{fontSize:17,color:"#65676B",textAlign:"center",maxWidth:300},primaryButton:{alignSelf:"flex-start",marginTop:30,backgroundColor:BLUE,borderRadius:12,paddingHorizontal:22,paddingVertical:14},primaryButtonText:{color:"#FFF",fontSize:16,fontWeight:"800"},modalRoot:{flex:1,justifyContent:"flex-end"},modalBackdrop:{...StyleSheet.absoluteFillObject,backgroundColor:"rgba(0,0,0,.4)"},sheet:{backgroundColor:"#F5F6F9",borderTopLeftRadius:28,borderTopRightRadius:28,maxHeight:"86%"},handle:{alignSelf:"center",width:76,height:6,borderRadius:3,backgroundColor:"#8A8D91",marginTop:10,marginBottom:6},sheetHeader:{height:58,flexDirection:"row",alignItems:"center",justifyContent:"space-between",paddingHorizontal:20},sheetTitle:{fontSize:20,fontWeight:"800",color:"#050505"},done:{fontSize:18,color:BLUE,fontWeight:"500"},disabled:{opacity:.45},sheetContent:{backgroundColor:"#FFF",margin:12,borderRadius:14,padding:16,paddingBottom:30},nameInput:{borderWidth:1,borderColor:"#D1D5DB",borderRadius:20,height:116,paddingHorizontal:18,fontSize:19,color:"#050505"},required:{fontSize:15,color:"#65676B",marginTop:8,marginBottom:28},optionRow:{minHeight:82,flexDirection:"row",alignItems:"center",justifyContent:"space-between",borderTopWidth:1,borderTopColor:"#F0F2F5"},optionCopy:{flex:1,paddingRight:15},optionTitle:{fontSize:17,fontWeight:"700",color:"#050505"},optionSubtitle:{fontSize:14,color:"#65676B",marginTop:4},disabledText:{color:"#B8BBC0"},friends:{paddingTop:14},friendHeading:{fontSize:17,fontWeight:"800",marginBottom:8},friendRow:{height:58,flexDirection:"row",alignItems:"center"},avatar:{width:42,height:42,borderRadius:21,backgroundColor:"#E4E6EB",overflow:"hidden",alignItems:"center",justifyContent:"center"},avatarImage:{width:42,height:42},avatarLetter:{fontSize:18,fontWeight:"800",color:"#65676B"},friendName:{flex:1,marginLeft:12,fontSize:16},check:{width:24,height:24,borderRadius:12,borderWidth:2,borderColor:"#BEC2C7",alignItems:"center",justifyContent:"center"},checkActive:{backgroundColor:BLUE,borderColor:BLUE},checkMark:{color:"#FFF",fontWeight:"800"}
});
