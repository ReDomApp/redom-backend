...
function Bullet({ icon, text }: { icon: any; text: string }) { return <View style={s.bullet}><GroupActionIcon kind={icon} size={28} color="#22A96B" /><Text style={s.bulletText}>{text}</Text></View>; }

const s = StyleSheet.create({
  root:{flex:1,backgroundColor:"#FFF"},header:{height:64,flexDirection:"row",alignItems:"center",justifyContent:"space-between",paddingHorizontal:18},handle:{width:62,height:6,borderRadius:3,backgroundColor:"#98A2B3"},content:{paddingHorizontal:28,paddingTop:22,paddingBottom:42,alignItems:"center"},illustration:{height:150,width:190,alignItems:"center",justifyContent:"center",backgroundColor:"#E6F8EC",borderRadius:30,marginBottom:30},title:{fontSize:30,lineHeight:37,fontWeight:"700",color:"#101828",textAlign:"center"},subtitle:{fontSize:17,lineHeight:25,color:"#667085",textAlign:"center",marginTop:18},bullet:{width:"100%",flexDirection:"row",alignItems:"flex-start",gap:18,marginTop:28},bulletText:{flex:1,fontSize:17,lineHeight:27,color:"#101828"},footer:{width:"100%",marginTop:34,alignItems:"center"},primary:{width:"100%",minHeight:56,borderRadius:30,backgroundColor:"#22A96B",alignItems:"center",justifyContent:"center"},primaryText:{color:"#FFF",fontSize:18,fontWeight:"700"},learn:{marginTop:24,fontSize:17,fontWeight:"700",color:"#218B67"}
});
