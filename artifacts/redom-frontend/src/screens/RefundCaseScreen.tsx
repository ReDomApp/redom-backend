            ...
            <>
              ...
              <View style={[styles.verifyCard, { backgroundColor: colors.surface, borderColor: colors.border }]}>
                ...
                <Pressable
                  ...
                  onPress={async () => {
                    try {
                      await ordersPaymentsService.resendStarsRefundCode(refundCase.transactionNumber);
                      setCode("");
                      await load();
                    } catch (err) {
                ...
                >
                  <Text style={[styles.resendText, { color: colors.text }]}>Send a new code</Text>
                </Pressable>
              </View>
            </>
          ) : null}
...
const styles = StyleSheet.create({
  ...
  verifyCard:{borderWidth:1,borderRadius:16,padding:17},resendButton:{height:44,borderWidth:1,borderRadius:11,alignItems:"center",justifyContent:"center",marginTop:10},resendText:{fontSize:14,fontWeight:"800"},verifyTitle:{fontSize:16,fontWeight:"800"},verifyTarget:{fontSize:13,marginTop:5},codeInput:{height:52,borderWidth:1,borderRadius:12,paddingHorizontal:15,fontSize:20,letterSpacing:4,marginTop:13,marginBottom:12},primaryButton:{minHeight:50,borderRadius:13,alignItems:"center",justifyContent:"center",paddingHorizontal:18},primaryButtonText:{color:"#FFF",fontSize:16,fontWeight:"900"},
