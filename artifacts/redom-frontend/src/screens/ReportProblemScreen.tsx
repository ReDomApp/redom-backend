...
function makeStyles(colors:ReturnType<typeof useTheme>["colors"]){return StyleSheet.create({
  ...
  intro:{padding:24,paddingBottom:48},hero:{alignItems:"center",paddingTop:18,paddingBottom:24},heroTitle:{fontSize:25,fontWeight:"800",color:colors.text,textAlign:"center",lineHeight:31,marginTop:18},heroText:{fontSize:17,color:"#1C1E21",textAlign:"center",lineHeight:25,marginTop:12},primary:{minHeight:54,borderRadius:10,backgroundColor:"#1877F2",alignItems:"center",justifyContent:"center",flexDirection:"row",gap:10,marginTop:12,paddingHorizontal:18},primaryText:{color:"#FFF",fontSize:17,fontWeight:"800"},secondary:{minHeight:54,borderRadius:10,backgroundColor:"#E4E6EB",alignItems:"center",justifyContent:"center",marginTop:12},secondaryText:{color:colors.text,fontSize:17,fontWeight:"700"},warning:{marginTop:22,padding:16,borderTopWidth:1,borderTopColor:"#E4E6EB"},warningTitle:{fontSize:17,fontWeight:"800",color:colors.text,lineHeight:23},warningText:{fontSize:15,color:colors.textSecondary,lineHeight:22,marginTop:7},linkRow:{paddingVertical:18},link:{color:"#1877F2",fontSize:16,fontWeight:"700",textAlign:"center",marginTop:16},
  page:{padding:22,paddingBottom:50},title:{fontSize:22,fontWeight:"800",color:colors.text,lineHeight:28,marginTop:12},body:{fontSize:16,color:"#1C1E21",lineHeight:24,marginTop:12},diagnosticCard:{marginTop:18,padding:14,borderRadius:12,backgroundColor:colors.background},cardTitle:{fontSize:15,fontWeight:"800",marginBottom:8},mono:{fontFamily:Platform.OS==="ios"?"Menlo":"monospace",fontSize:11,color:"#1C1E21",lineHeight:16},
  productPage:{paddingBottom:30},productRow:{minHeight:60,borderBottomWidth:1,borderBottomColor:colors.border,paddingHorizontal:20,flexDirection:"row",alignItems:"center",justifyContent:"space-between"},productSelected:{backgroundColor:"#F0F7FF"},productText:{fontSize:16,color:colors.text},check:{fontSize:20,color:"#1877F2",fontWeight:"800"},
  form:{padding:18,paddingBottom:50},selectedProduct:{backgroundColor:colors.background,borderRadius:12,padding:14},smallLabel:{fontSize:11,fontWeight:"800",color:colors.textSecondary,letterSpacing:1},selectedText:{fontSize:17,fontWeight:"700",marginTop:5,color:colors.text},section:{fontSize:17,fontWeight:"800",marginTop:20,marginBottom:8},chips:{gap:8,paddingVertical:4},chip:{paddingHorizontal:13,paddingVertical:9,borderRadius:20,backgroundColor:"#E4E6EB"},chipActive:{backgroundColor:"#1877F2"},chipText:{fontSize:13,color:colors.text},chipTextActive:{color:"#FFF",fontWeight:"700"},description:{minHeight:150,borderWidth:1,borderColor:"#CCD0D5",borderRadius:14,padding:16,fontSize:17,textAlignVertical:"top",marginTop:12,color:colors.text},mediaButton:{minHeight:54,borderRadius:10,backgroundColor:"#E4E6EB",alignItems:"center",justifyContent:"center",flexDirection:"row",gap:10,marginTop:10},mediaText:{fontSize:16,fontWeight:"700",color:colors.text},attachment:{marginTop:10,padding:10,borderRadius:10,backgroundColor:colors.background,flexDirection:"row",alignItems:"center",gap:10},attachmentPreview:{width:48,height:48,borderRadius:8,overflow:"hidden",alignItems:"center",justifyContent:"center",backgroundColor:colors.surface},preview:{width:48,height:48},attachmentName:{fontSize:14,fontWeight:"700",color:colors.text},attachmentType:{fontSize:12,color:colors.textSecondary,marginTop:2},remove:{fontSize:28,color:colors.textSecondary,paddingHorizontal:8},privacy:{fontSize:14,color:colors.textSecondary,textAlign:"center",marginTop:18},footer:{fontSize:12,color:colors.textSecondary,lineHeight:18,textAlign:"center",marginTop:18},disabled:{opacity:0.6}
}); }
