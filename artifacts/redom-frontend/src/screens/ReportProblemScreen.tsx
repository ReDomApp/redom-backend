...
export function ReportProblemScreen({}: Props) {
  ...
  return <SafeAreaView style={s.root}>
    ...
    {stage === "form" ? <ScrollView contentContainerStyle={s.form}>
      ...
      <Pressable style={s.mediaButton} onPress={() => Alert.alert("Record screen", "Use your device's screen recorder, then return here and tap Upload From Phone to attach the recording.")}><ReportVideoIcon width={28} height={28}/><Text style={s.mediaText}>Record screen</Text></Pressable>
      ...
      <Text style={s.footer}>Your report receives a 6–11 digit Report ID. The report includes the problem, product, category and the fix required for administrators to investigate. Screenshots or videos are included only when you attach them.</Text>
    </ScrollView> : null}
  </SafeAreaView>;
}

const s = StyleSheet.create({
  root:{flex:1,backgroundColor:"#FFF"}, header:{height:58,borderBottomWidth:1,borderBottomColor:"#E4E6EB",flexDirection:"row",alignItems:"center",justifyContent:"space-between",paddingHorizontal:12,backgroundColor:"#FFF"}, back:{fontSize:38,color:"#050505",lineHeight:42},headerTitle:{fontSize:19,fontWeight:"800",color:"#050505"},
  intro:{padding:24,paddingBottom:48},hero:{alignItems:"center",paddingTop:18,paddingBottom:24},heroTitle:{fontSize:25,fontWeight:"800",color:"#050505",textAlign:"center",lineHeight:31,marginTop:18},heroText:{fontSize:17,color:"#1C1E21",textAlign:"center",lineHeight:25,marginTop:12},primary:{minHeight:54,borderRadius:10,backgroundColor:"#1877F2",alignItems:"center",justifyContent:"center",flexDirection:"row",gap:10,marginTop:12,paddingHorizontal:18},primaryText:{color:"#FFF",fontSize:17,fontWeight:"800"},secondary:{minHeight:54,borderRadius:10,backgroundColor:"#E4E6EB",alignItems:"center",justifyContent:"center",marginTop:12},secondaryText:{color:"#050505",fontSize:17,fontWeight:"700"},warning:{marginTop:22,padding:16,borderTopWidth:1,borderTopColor:"#E4E6EB"},warningTitle:{fontSize:17,fontWeight:"800",color:"#050505",lineHeight:23},warningText:{fontSize:15,color:"#65676B",lineHeight:22,marginTop:7},linkRow:{paddingVertical:18},link:{color:"#1877F2",fontSize:16,fontWeight:"700",textAlign:"center",marginTop:16},
  page:{padding:22,paddingBottom:50},title:{fontSize:22,fontWeight:"800",color:"#050505",lineHeight:28,marginTop:12},body:{fontSize:16,color:"#1C1E21",lineHeight:24,marginTop:12},diagnosticCard:{marginTop:18,padding:14,borderRadius:12,backgroundColor:"#F0F2F5"},cardTitle:{fontSize:15,fontWeight:"800",marginBottom:8},mono:{fontFamily:Platform.OS==="ios"?"Menlo":"monospace",fontSize:11,color:"#1C1E21",lineHeight:16},
  productPage:{paddingBottom:30},productRow:{minHeight:60,borderBottomWidth:1,borderBottomColor:"#E4E6EB",paddingHorizontal:20,flexDirection:"row",alignItems:"center",justifyContent:"space-between"},productSelected:{backgroundColor:"#F0F7FF"},productText:{fontSize:16,color:"#050505"},check:{fontSize:20,color:"#1877F2",fontWeight:"800"},
  form:{padding:18,paddingBottom:50},selectedProduct:{backgroundColor:"#F0F2F5",borderRadius:12,padding:14},smallLabel:{fontSize:11,fontWeight:"800",color:"#65676B",letterSpacing:1},selectedText:{fontSize:17,fontWeight:"700",marginTop:5,color:"#050505"},section:{fontSize:17,fontWeight:"800",marginTop:20,marginBottom:8},chips:{gap:8,paddingVertical:4},chip:{paddingHorizontal:13,paddingVertical:9,borderRadius:20,backgroundColor:"#E4E6EB"},chipActive:{backgroundColor:"#1877F2"},chipText:{fontSize:13,color:"#050505"},chipTextActive:{color:"#FFF",fontWeight:"700"},description:{minHeight:150,borderWidth:1,borderColor:"#CCD0D5",borderRadius:14,padding:16,fontSize:17,textAlignVertical:"top",marginTop:12,color:"#050505"},mediaButton:{minHeight:54,borderRadius:10,backgroundColor:"#E4E6EB",alignItems:"center",justifyContent:"center",flexDirection:"row",gap:10,marginTop:10},mediaText:{fontSize:16,fontWeight:"700",color:"#050505"},attachment:{marginTop:10,padding:10,borderRadius:10,backgroundColor:"#F0F2F5",flexDirection:"row",alignItems:"center",gap:10},attachmentPreview:{width:48,height:48,borderRadius:8,overflow:"hidden",alignItems:"center",justifyContent:"center",backgroundColor:"#FFF"},preview:{width:48,height:48},attachmentName:{fontSize:14,fontWeight:"700",color:"#050505"},attachmentType:{fontSize:12,color:"#65676B",marginTop:2},remove:{fontSize:28,color:"#65676B",paddingHorizontal:8},privacy:{fontSize:14,color:"#65676B",textAlign:"center",marginTop:18},footer:{fontSize:12,color:"#65676B",lineHeight:18,textAlign:"center",marginTop:18},disabled:{opacity:0.6}
});
