...
function makeStyles(colors: ReturnType<typeof useTheme>["colors"]) { return StyleSheet.create({
  card: { backgroundColor: colors.surface, marginTop: 8, paddingTop: 12, paddingBottom: 3 }, header: { flexDirection: "row", alignItems: "center", paddingHorizontal: 12 }, identity: { flex: 1, marginLeft: 10 }, nameRow: { flexDirection: "row", alignItems: "center", gap: 5 }, name: { fontSize: 16, fontWeight: "700", color: colors.text }, meta: { fontSize: 12, color: colors.textSecondary, marginTop: 2 }, headerActions: { flexDirection: "row" }, iconButton: { padding: 7 }, body: { paddingHorizontal: 12, paddingTop: 10 }, bodyText: { fontSize: 16, lineHeight: 22, color: colors.text }, media: { width: "100%", height: 280, marginTop: 10 }, recommended: { fontSize: 12, color: colors.textSecondary, paddingHorizontal: 12, paddingTop: 8 }, summaryRow: { minHeight: 38, flexDirection: "row", alignItems: "center", paddingHorizontal: 12, gap: 12, borderBottomWidth: 1, borderBottomColor: colors.border }, reactionSummary: { flex: 1, flexDirection: "row", alignItems: "center" }, summaryCount: { color: colors.textSecondary, fontSize: 13, marginLeft: 5 }, countText: { color: colors.textSecondary, fontSize: 12 }, actionRow: { height: 48, flexDirection: "row", alignItems: "center", paddingHorizontal: 8 }, actionWrap: { flex: 1, position: "relative" }, action: { minHeight: 42, alignItems: "center", justifyContent: "center", flexDirection: "row", gap: 7 }, actionText: { color: colors.textSecondary, fontWeight: "600", fontSize: 14 }, active: { color: "#1877F2" }, tray: { position: "absolute", bottom: 44, left: 0, flexDirection: "row", backgroundColor: colors.surface, borderRadius: 28, padding: 7, elevation: 8, shadowOpacity: 0.2, shadowRadius: 8, zIndex: 20 }, trayItem: { paddingHorizontal: 4 }, notInterested: { paddingHorizontal: 18, paddingBottom: 18 }, titleRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginBottom: 12 }, title: { flex: 1, fontSize: 20, fontWeight: "700" }, reasonGrid: { flexDirection: "row", flexWrap: "wrap", gap: 8 }, reason: { backgroundColor: colors.background, borderRadius: 18, paddingHorizontal: 13, paddingVertical: 10 }, reasonText: { fontSize: 13, color: colors.text }, otherTitle: { fontSize: 14, fontWeight: "700", marginTop: 18, marginBottom: 4 }, otherRow: { flexDirection: "row", alignItems: "center", gap: 12, paddingVertical: 10 }, modalBackdrop: { flex: 1, backgroundColor: "rgba(0,0,0,.38)", justifyContent: "flex-end" }, reactionSheet: { backgroundColor: colors.surface, minHeight: "55%", maxHeight: "80%", borderTopLeftRadius: 18, borderTopRightRadius: 18, padding: 18 }, total: { color: colors.textSecondary, marginBottom: 12 }, topRow: { flexDirection: "row", gap: 18, marginBottom: 14 }, topItem: { flexDirection: "row", alignItems: "center", gap: 4 }, privacy: { fontSize: 12, color: colors.textSecondary, marginBottom: 10 }, reactor: { flexDirection: "row", alignItems: "center", gap: 10, paddingVertical: 7 }, reactorName: { flex: 1, fontSize: 16, fontWeight: "600" },
}); }
