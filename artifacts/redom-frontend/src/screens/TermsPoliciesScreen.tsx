...
const groups: PolicyGroup[] = [
  ...
  { title: "Products, Availability and Payments", Icon: OrdersIcon, items: [
    ...
    { slug: "payments", title: "Payments Terms", description: "Orders, payment methods, subscriptions, secure payment processing and payment security controls.", Icon: OrdersIcon },
