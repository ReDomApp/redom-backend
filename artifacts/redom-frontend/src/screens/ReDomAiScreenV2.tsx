...
import { AiAttachIcon, AiBackIcon, AiCameraIcon, AiCloseIcon, AiCopyIcon, AiDislikeIcon, AiDocumentIcon, AiEditIcon, AiHistoryIcon, AiImageIcon, AiInfoIcon, AiLikeIcon, AiMoreIcon, AiRetryIcon, AiSearchIcon, AiSendIcon, AiShareIcon, AiSparkIcon } from "../assets/ai/AiIcon";
...
export function ReDomAiScreenV2({ navigation, route }: Props) {
  ...
  useEffect(() => {
    if (route.params.prefill) setInput(route.params.prefill);
    if (route.params.imageMode !== undefined) setImagePromptMode(route.params.imageMode);
  }, [route.params.imageMode, route.params.prefill]);
