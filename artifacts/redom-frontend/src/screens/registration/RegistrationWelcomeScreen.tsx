      ...
      >
        ...
        <View style={styles.descriptionRow}>
          <Text style={styles.description}>
            Create an account to connect with friends, family and communities of people who share your interests around the globe{" "}
          </Text>
        ...
        <View style={styles.progress} accessibilityLabel="Account creation progress, step 1 of 6">
          {[0, 1, 2, 3, 4, 5].map((step) => (
            <View key={step} style={[styles.dot, step === 0 && styles.dotActive]} />
          ))}
        </View>
        ...
        <View style={styles.legalRow}>
          <Pressable onPress={() => setError("Terms & Conditions will be available in the ReDom legal center.")}>
            <Text style={styles.legal}>Terms & Conditions</Text>
          </Pressable>
          <Text style={styles.separator}>•</Text>
          <Pressable onPress={() => setError("Privacy Policy will be available in the ReDom legal center.")}>
            <Text style={styles.legal}>Privacy Policy</Text>
          </Pressable>
          <Text style={styles.separator}>•</Text>
          <Pressable onPress={() => setError("Community Guidelines will be available in the ReDom legal center.")}>
            <Text style={styles.legal}>Community Guidelines</Text>
          </Pressable>
        </View>
