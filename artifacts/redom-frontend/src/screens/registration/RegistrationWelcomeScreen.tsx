...
export function RegistrationWelcomeScreen({ navigation }: Props) {
  ...
  const createAccount = useCallback(async () => {
    ...
    try {
      ...
      animation.stop();
      navigation.replace("RegistrationContact", reservation);
    } catch (e) {
      animation.stop();
  ...
  return (
    <View style={styles.screen}>
      <View style={styles.card}>
        ...
        <Pressable disabled={loading} onPress={() => navigation.navigate("Login")} style={styles.secondaryButton}><Text style={styles.secondaryText}>Find Your Account</Text></Pressable>
        ...
        <View style={styles.loginRow}><Text style={styles.muted}>Already have an account? </Text><Pressable onPress={() => navigation.navigate("Login")}><Text style={styles.link}>Login</Text></Pressable></View>
...
const styles = StyleSheet.create({
  screen: { flex: 1, backgroundColor: "#F0F2F5", justifyContent: "center", padding: 20 },
  card: { width: "100%", maxWidth: 430, alignSelf: "center", backgroundColor: "#FFFFFF", borderRadius: 22, paddingHorizontal: 28, paddingVertical: 34, shadowColor: "#000000", shadowOffset: { width: 0, height: 14 }, shadowOpacity: 0.08, shadowRadius: 32, elevation: 6 },
  ...
  descriptionRow: { flexDirection: "row", alignItems: "center", justifyContent: "center", flexWrap: "wrap", marginBottom: 27 },
  description: { textAlign: "center", color: MUTED, fontSize: 15, lineHeight: 23 },
  primaryButton: { height: 54, borderRadius: 13, backgroundColor: BLUE, alignItems: "center", justifyContent: "center" },
  primaryText: { color: "#FFFFFF", fontSize: 17, fontWeight: "800" },
  secondaryButton: { height: 54, marginTop: 12, borderRadius: 13, borderWidth: 2, borderColor: BLUE, alignItems: "center", justifyContent: "center" },
  ...
  progress: { flexDirection: "row", justifyContent: "center", gap: 8, marginTop: 27, marginBottom: 22 },
  ...
  legalRow: { flexDirection: "row", justifyContent: "center", alignItems: "center", flexWrap: "wrap", gap: 7, marginTop: 24 },
  legal: { color: BLUE, fontSize: 11.5, fontWeight: "700" },
  separator: { color: "#8A8D91", fontSize: 11 },
  company: { textAlign: "center", color: MUTED, fontSize: 12, marginTop: 14 },
});
