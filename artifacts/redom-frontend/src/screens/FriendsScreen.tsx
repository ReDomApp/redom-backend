...
root:{flex:1,backgroundColor: colors.surface},header:{height:64,borderBottomWidth:1,borderBottomColor: colors.border,flexDirection:"row",alignItems:"center",justifyContent:"space-between",paddingHorizontal:18},headerTitle:{fontSize:22,fontWeight:"800",color: colors.text},headerSearch:{width:30,height:30},tabs:{paddingHorizontal:22,paddingVertical:14,gap:10},tab:{paddingHorizontal:20,paddingVertical:10,borderRadius:24,backgroundColor:"#E4E6EB"},activeTab:{backgroundColor:"#E5F0FF"},tabText:{fontSize:17,fontWeight:"700",color: colors.text},activeTabText:{color:"#1877F2"},searchBox:{marginHorizontal:24,marginBottom:18,height:54,borderRadius:28,backgroundColor: colors.background,flexDirection:"row",alignItems:"center",paddingHorizontal:14},searchInput:{flex:1,fontSize:17,paddingHorizontal:7,color: colors.text},content:{paddingHorizontal:22,paddingBottom:40},sectionTitle:{fontSize:28,fontWeight:"800",color: colors.text,marginVertical:14},person:{minHeight:88,flexDirection:"row",alignItems:"center",paddingVertical:8},identity:{flex:1,flexDirection:"row",alignItems:"center",minWidth:0},avatar:{width:66,height:66,borderRadius:33,backgroundColor:"#E5E7EB"},avatarFallback:{width:66,height:66,borderRadius:33,backgroundColor:"#E5F0FF",alignItems:"center",justifyContent:"center"},initial:{fontSize:25,fontWeight:"800",color:"#1877F2"},nameWrap:{flex:1,paddingHorizontal:12},name:{fontSize:19,fontWeight:"700",color: colors.text,lineHeight:23},sub:{fontSize:15,color: colors.textSecondary,marginTop:2},verified:{fontSize:13,color:"#1877F2",fontWeight:"700",marginTop:2},moreBtn:{width:48,height:48,borderRadius:24,alignItems:"center",justifyContent:"center"},actionPair:{width:238,flexDirection:"row",gap:8},primaryBtn:{flex:1,minHeight:48,borderRadius:10,backgroundColor:"#1877F2",alignItems:"center",justifyContent:"center",paddingHorizontal:10},primaryText:{fontSize:15,fontWeight:"800",color:"#FFF"},secondaryBtn:{flex:1,minHeight:48,borderRadius:10,backgroundColor:"#E4E6EB",alignItems:"center",justifyContent:"center",paddingHorizontal:10},secondaryText:{fontSize:15,fontWeight:"800",color: colors.text},requests:{marginBottom:8},requestRow:{paddingVertical:8},requestActions:{flexDirection:"row",gap:10,marginLeft:78,marginTop:-4},empty:{alignItems:"center",paddingTop:90,paddingHorizontal:30},emptyTitle:{fontSize:24,fontWeight:"800",textAlign:"center",marginTop:15,color: colors.text},emptyText:{fontSize:16,color: colors.textSecondary,textAlign:"center",lineHeight:23,marginTop:8},backdrop:{flex:1,backgroundColor:"rgba(0,0,0,.38)"},sheet:{backgroundColor: colors.surface,borderTopLeftRadius:26,borderTopRightRadius:26,paddingTop:12,paddingBottom:28},handle:{width:74,height:6,borderRadius:3,backgroundColor:"#8B8F95",alignSelf:"center",marginBottom:15},sheetPerson:{flexDirection:"row",alignItems:"center",paddingHorizontal:24,paddingBottom:14},sheetAvatar:{width:58,height:58,borderRadius:29},sheetAvatarFallback:{width:58,height:58,borderRadius:29,backgroundColor:"#E5F0FF",alignItems:"center",justifyContent:"center"},sheetName:{fontSize:20,fontWeight:"800",color: colors.text,marginLeft:14},sheetRow:{minHeight:64,paddingHorizontal:24,flexDirection:"row",alignItems:"center",gap:18},sheetText:{fontSize:18,fontWeight:"700",color: colors.text}
}); }
