...
export function FriendsScreen(){
 ...
 const load=useCallback(async(refresh=false)=>{
   ...
   try{
     const result=viewedUserId?await friendsService.profileFriends(viewedUserId):tab==="friends"?await friendsService.list(query.trim()||undefined):tab==="following"?await friendsService.following():tab==="suggested"?await friendsService.suggested(query.trim()||undefined):await friendsService.common();
