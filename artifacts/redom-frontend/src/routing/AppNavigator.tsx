...
import { CoverPhotoAdjustScreen } from "../screens/CoverPhotoAdjustScreen";
import { CoverPhotoPreviewScreen } from "../screens/CoverPhotoPreviewScreen";
import { CoverPhotoViewerScreen } from "../screens/CoverPhotoViewerScreen";
import { CustomizingExperienceScreen } from "../screens/CustomizingExperienceScreen";
import { LoginScreen } from "../screens/LoginScreen";
import { StartupScreen } from "../screens/StartupScreen";
import { SearchScreen } from "../screens/SearchScreen";
import { NotificationsScreen } from "../screens/NotificationsScreen";
import { MessagesScreenWithAi } from "../screens/MessagesScreenWithAi";
import { ReDomAiScreenV2 } from "../screens/ReDomAiScreenV2";
import { ChatScreenWithAi } from "../screens/ChatScreenWithAi";
import { ChatContactInfoScreen } from "../screens/ChatContactInfoScreen";
import { ChatEncryptionVerificationScreen } from "../screens/ChatEncryptionVerificationScreen";
import { CallScreenLoader } from "../screens/CallScreenLoader";
import { CallLinkJoinScreen } from "../screens/CallLinkJoinScreen";
...
export function AppNavigator() {
  ...
  return <Stack.Navigator initialRouteName={status === "authenticated" ? "HomeFeed" : "Login"} screenOptions={{ headerShown: false, animation: "fade", contentStyle: { backgroundColor: "#FFFFFF" }} }>
    {status === "authenticated" ? <>
      <Stack.Screen name="HomeFeed" component={ActiveHomeFeedScreen} /><Stack.Screen name="Profile" component={ProfileScreen} /><Stack.Screen name="EditProfile" component={EditProfileScreen} /><Stack.Screen name="EditBio" component={EditBioScreen} /><Stack.Screen name="EditLocationSearch" component={EditLocationSearchScreen} /><Stack.Screen name="EditLocationConfirm" component={EditLocationConfirmScreen} /><Stack.Screen name="EditBirthday" component={EditBirthdayScreen} /><Stack.Screen name="ProfilePictureAdjust" component={ProfilePictureAdjustScreen} /><Stack.Screen name="ProfilePicturePreview" component={ProfilePicturePreviewScreen} /><Stack.Screen name="ProfilePictureViewer" component={ProfilePictureViewerScreen} /><Stack.Screen name="CoverPhotoAdjust" component={CoverPhotoAdjustScreen} /><Stack.Screen name="CoverPhotoPreview" component={CoverPhotoPreviewScreen} /><Stack.Screen name="CoverPhotoViewer" component={CoverPhotoViewerScreen} /><Stack.Screen name="Foundation" component={FoundationScreen} /><Stack.Screen name="Search" component={SearchScreen} /><Stack.Screen name="Notifications" component={NotificationsScreen} /><Stack.Screen name="Messages" component={MessagesScreenWithAi} /><Stack.Screen name="ReDomAI" component={ReDomAiScreenV2} /><Stack.Screen name="Chat" component={ChatScreenWithAi} /><Stack.Screen name="ChatContactInfo" component={ChatContactInfoScreen} /><Stack.Screen name="ChatEncryptionVerification" component={ChatEncryptionVerificationScreen} /><Stack.Screen name="Call" component={CallScreenLoader} /><Stack.Screen name="CallLinkJoin" component={CallLinkJoinScreen} /><Stack.Screen name="CreateGroup" component={CreateGroupScreen} /><Stack.Screen name="GroupInfo" component={GroupInfoScreen} /><Stack.Screen name="Settings" component={SettingsScreen} /><Stack.Screen name="NotificationSettings" component={SettingsSubscreen} /><Stack.Screen name="PrivacySettings" component={SettingsSubscreen} /><Stack.Screen name="SecuritySettings" component={SettingsSubscreen} /><Stack.Screen name="LinkedDevices" component={LinkedDevicesScreen} /><Stack.Screen name="LinkDevice" component={LinkDeviceScreen} /><Stack.Screen name="BlockedUsers" component={SettingsSubscreen} /><Stack.Screen name="Verification" component={SettingsSubscreen} /><Stack.Screen name="Support" component={SettingsSubscreen} /><Stack.Screen name="Policy" component={PolicyScreen} />
    </> : <>
