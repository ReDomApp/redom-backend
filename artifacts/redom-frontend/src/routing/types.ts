...
export type RootStackParamList = {
  ...
  LoginTwoFactor: { challengeId: string; channel: "sms" | "email" | "whatsapp" | "authenticator"; maskedTarget: string; expiresAt: string };
  RegistrationWelcome: undefined; RegistrationIdentity: RegistrationFlowReservationRouteParams; RegistrationBirthday: RegistrationFlowReservationRouteParams; RegistrationGender: RegistrationFlowReservationRouteParams; RegistrationPhone: RegistrationFlowReservationRouteParams; RegistrationEmail: RegistrationFlowReservationRouteParams; RegistrationPassword: RegistrationFlowReservationRouteParams; RegistrationReview: RegistrationFlowReservationRouteParams;
  RegistrationVerification: { verificationChallengeId: string; reservationId?: string; deviceId?: string; flowId: string; channel: "sms" | "email" };
  ...
  Search: undefined; Notifications: undefined; Messages: undefined; NewMessage: undefined; ReDomAI: undefined; Chat: { conversationId: string }; Call: { conversationId: string; callType: "voice" | "video"; callId?: string }; CreateGroup: undefined; GroupInfo: { conversationId: string };
  Settings: undefined; NotificationSettings: undefined; PrivacySettings: undefined; SecuritySettings: undefined; BlockedUsers: undefined; Verification: undefined; Support: undefined;
