...
export type RootStackParamList = {
  ...
  Search: undefined; Notifications: undefined; Messages: undefined; ReDomAI: { conversationId?: string }; Chat: { conversationId: string }; ChatContactInfo: { conversationId: string }; Call: { conversationId: string; callType: "voice" | "video"; callId?: string }; CreateGroup: undefined; GroupInfo: { conversationId: string };
