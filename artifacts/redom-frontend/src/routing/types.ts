...
export type RootStackParamList = {
  ...
  Search: undefined; Notifications: undefined; Messages: undefined; ReDomAI: { conversationId?: string; context?: string }; Chat: { conversationId: string }; ChatContactInfo: { conversationId: string }; ChatEncryptionVerification: { conversationId: string }; Call: { conversationId: string; callType: "voice" | "video"; callId?: string }; CallLinkJoin: { token: string }; CreateGroup: undefined; GroupInfo: { conversationId: string };
