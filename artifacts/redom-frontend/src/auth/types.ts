...
export interface RegistrationFlowEmailSaveResult { success: boolean; reservationId: string; flowId: string; email: string; provider: "google" | "microsoft" | "yahoo"; verificationSent: boolean; verificationExpiresAt: string; }
