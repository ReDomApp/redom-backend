...
export function App(){return <SafeAreaProvider><LanguageContainer><AuthProvider><NavigationContainer linking={linking}><StatusBar style="auto"/><AppNavigator/></NavigationContainer></AuthProvider></LanguageContainer></SafeAreaProvider>;}