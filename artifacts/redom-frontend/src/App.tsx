...
export function App(){return <SafeAreaProvider><LanguageContainer><ThemeProvider><AuthProvider><NavigationContainer linking={linking}><StatusBar style="auto"/><AppNavigator/></NavigationContainer></AuthProvider></ThemeProvider></LanguageContainer></SafeAreaProvider>;}