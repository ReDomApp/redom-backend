...
export async function loadLanguage(): Promise<LanguageCode> {
  ...
  if (stored && LANGUAGES.some((item) => item.code === stored)) return stored as LanguageCode;
...
const translations: Record<LanguageCode, Record<string, string>> = {
  ...
  es: {
    ...
    findAccount: "Encontrar tu cuenta",
    alreadyAccount: "¿Ya tienes una cuenta?",
    login: "Iniciar sesión",
    loginTitle: "Inicia sesión en ReDom",
    mobileOrEmail: "Número móvil o correo electrónico",
    password: "Contraseña",
    forgotPassword: "¿Olvidaste tu contraseña?",
    or: "O",
    whatsName: "¿Cuál es tu nombre?",
    realName: "Escribe el nombre que usas en la vida real.",
    everydayName: "Escribe el nombre que usas todos los días.",
    firstName: "Nombre",
    lastName: "Apellido",
    continue: "Continuar",
    flowId: "Tu ID de flujo de ReDom es {flowId}. Úsalo dentro de 30 minutos.",
    language: "Idioma",
  ...
  fr: { languageUpdated: "Langue INAPP ReDom mise à jour" },
  de: { languageUpdated: "ReDom INAPP-Sprache aktualisiert" },
  pt: { languageUpdated: "Idioma INAPP do ReDom atualizado" },
  it: { languageUpdated: "Lingua INAPP di ReDom aggiornata" },
  nl: { languageUpdated: "ReDom INAPP-taal bijgewerkt" },
  ar: { languageUpdated: "تم تحديث لغة ReDom داخل التطبيق" },
  zh: { languageUpdated: "ReDom 应用内语言已更新" },
  ja: { languageUpdated: "ReDomアプリ内言語を更新しました" },
  ko: { languageUpdated: "ReDom 앱 언어가 업데이트되었습니다" },
  hi: { languageUpdated: "ReDom इनऐप भाषा अपडेट की गई" },
  ru: { languageUpdated: "Язык ReDom в приложении обновлён" },
  tr: { languageUpdated: "ReDom uygulama dili güncellendi" },
};
