CREATE TABLE IF NOT EXISTS bug_reports (
  ...
  CONSTRAINT bug_reports_report_id_format CHECK (report_id ~ '^[0-9]{6,11}$'),
...
CREATE INDEX IF NOT EXISTS bug_report_attachments_report_idx ON bug_report_attachments(report_id, created_at ASC);
