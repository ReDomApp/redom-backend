...
CREATE INDEX IF NOT EXISTS payment_transactions_subscription_idx ON payment_transactions(subscription_id, created_at DESC);
...
CREATE INDEX IF NOT EXISTS payment_subscriptions_user_idx ON payment_subscriptions(user_id, created_at DESC);
...
CREATE INDEX IF NOT EXISTS payment_webhook_reference_idx ON payment_webhook_events(reference, created_at DESC);