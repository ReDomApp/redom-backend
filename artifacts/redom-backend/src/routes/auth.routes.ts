...
router.get(
  "/network-provider",
  authRateLimit,
  networkProviderController.get.bind(networkProviderController),
);
...
router.post(
  "/register/challenge",
  authRateLimit,
  registrationChallengeController.start.bind(registrationChallengeController),
);
router.get(
  "/register/challenge/:challengeId",
  authRateLimit,
  registrationChallengeController.getFlow.bind(registrationChallengeController),
);
router.patch(
  "/register/challenge/:challengeId",
  authRateLimit,
  registrationChallengeController.saveStep.bind(registrationChallengeController),
);
router.post(
  "/register/challenge/:challengeId/complete",
  authRateLimit,
...
router.post(
  "/verify-login-device",
  verificationRateLimit,
  authController.verifyLoginDevice.bind(authController),
);
...
router.post(
  "/resend-email-code",
  verificationRateLimit,
  authController.resendEmailCode.bind(authController),
);
router.post(
  "/resend-phone-code",
  verificationRateLimit,
  authController.resendPhoneCode.bind(authController),
);
