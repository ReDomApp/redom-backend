...
export const REDOM_SUPPORT_POLICY_DOCUMENTS: ReDomPolicyDocument[] = [
  ...
  { slug: "payments", title: "ReDom Payments Terms", summary: "Rules for orders, payment methods, subscriptions, secure payment processing and payment security.", version: "1.0.0", effectiveAt: "2026-09-24T00:00:00.000Z", sections: [{ heading: "Orders and payments", body: "Orders and payment states are backend-confirmed. Client screens do not fabricate completed payments." }, { heading: "Subscriptions", body: "Subscription status and billing information come from confirmed records." }, { heading: "Security", body: "Supported payment confirmations may use PIN, biometrics or provider authentication." }] },
